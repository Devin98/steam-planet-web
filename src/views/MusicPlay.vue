      ...
      <div class="player-inner">
        <mu-appbar>
          ...
          <div class="play-title">
            <div class="play-name"><span>{{song.songName}}</span></div>
            <div class="play-singer"> {{song.author}} </div>
          </div>
          ...
          <mu-flexbox-item order="0">
            <div class="cd-holder" :class="{'cd-play': playing}">
              ...
              <div class="cd-wrapper" :class="{'cd-rotate': playing}">
                ...
                <img class="cd-img" src="../static/placeholder_disk_play_program.png"/>
                <!--audio.albumPic + '?param=500y500'-->
              </div>
            </div>
          </mu-flexbox-item>
          <mu-flexbox-item order="2" class="bottom-wrapper">
            ...
            <div class="process-bar">
              <div class="pro">
                ...
                <div class="time">
                  <time id="cur" style="margin-left: -10px;">{{currentTime | time}}</time>
                  <time id="total" style="margin-left: 10px;">{{durationTime | time}}</time>
                </div>
              </div>
            </div>
            <div class="control-bar " style="text-align: center;">
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      song(){
        return this.$store.getters['music/getCurrentMusic'];
      },
      lrcOffset () {
        if (this.afterLrc) {
          // 1、根据时间获得歌词
