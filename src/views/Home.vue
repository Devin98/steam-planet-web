...
//  },
  ...
  methods: {
    ...
    ToSongList(){
      this.$router.push({path:'/weekSong'});
    },
    ToFriend(){
      this.$router.push({path:'/friendsList'});
    ...
    ToWeekTopic(){
      this.$store
        .commit({
          type:'topic/setWeekTopicId',
          weekTopicId: this.weekTopic._id,
        });

      console.log(this.weekTopic._id);
